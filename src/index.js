    ...
    <section class="benefits-section">
      <div class="container">
        <div class="benefit">
          ...
          <p>
            Students no longer need to come out late at night to dispose of
            their garbage. Throwaydotty has got you covered.
          </p>
        </div>
        <div class="benefit">
          <div class="icon">
          ...
          <p>
            Our customers will no longer have issues with the waste management
            taskforce of Rivers State over disposing dirt at the wrong time. We
            have you covered.
          </p>
        </div>
        <div class="benefit">
          ...
          <p>
            Our clients no longer need to walk long distances carrying heavy
            garbage to dispose of it. Let us handle it for you.
          </p>
        </div>
      </div>
    </section>
